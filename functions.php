...
function soviet_scripts() {
	...
	wp_enqueue_script( 'angular-core', get_template_directory_uri() . '/js/angular.js', array(), '1.3.1', true );
	wp_enqueue_script( 'angular-route', get_template_directory_uri() . '/js/angular-route.min.js', array('angular-core'), '1.3.1', true );
	wp_enqueue_script( 'angular-resource', get_template_directory_uri() . '/js/angular-resource.min.js', array('angular-core'), '1.3.1', true );
